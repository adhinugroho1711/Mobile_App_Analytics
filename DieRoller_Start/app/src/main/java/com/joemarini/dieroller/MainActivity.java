...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fbAnalytics.setMinimumSessionDuration(5000);
        fbAnalytics.setSessionTimeoutDuration(300000);
    ...
    private void rollTheDice() {
        ...
        bundle.putInt("DieSize", mDieSize);
        fbAnalytics.logEvent(evt, bundle);
    ...
    private void incrementRollCount() {
        ...
        if (rollCount > HIGH_ROLLER_COUNT) {
            ...
            if (!isHR) {
                ...
                fbAnalytics.setUserProperty("is_high_roller", "is_high_roller");
            }
        }
        editor.apply();
    }
